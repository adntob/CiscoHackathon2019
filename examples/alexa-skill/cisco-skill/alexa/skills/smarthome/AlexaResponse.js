        ...
        let endpoint =
            {
                ...
                "description": this.checkValue(opts.description, "Cisco Room Kit"),
                ...
                "friendlyName": this.checkValue(opts.friendlyName, "cisco room kit"),
                "manufacturerName": this.checkValue(opts.manufacturerName, "Cisco")
            };
